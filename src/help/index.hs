...
<helpset>
	<title>Signal Plotter. Help Contents</title>
		<maps>
			<homeID>introduccion</homeID>		<!-- Página por defecto al mostrar la ayuda -->
		...
		<presentation default="true" displayviews="true" displayviewimages="true">
			...
			<location x="300" y="150"/>			<!-- Posición inicial -->
			<title>Signal Plotter. Help Contents</title> <!-- Título de la ventana -->
